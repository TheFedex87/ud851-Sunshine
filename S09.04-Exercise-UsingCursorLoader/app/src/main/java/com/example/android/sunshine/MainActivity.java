...
//          TODO (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        ...
        switch (loaderId){
            case ID_FORECAST_LOADER:
                ...
                CursorLoader cursorLoader = new CursorLoader(this, forecastQueryUri, DESIDERED_COLUMNS, selection, null, WeatherContract.WeatherEntry.COLUMN_DATE + " ASC");
                Log.d(TAG, "Creating cursor: " + String.valueOf(cursorLoader.hashCode()));
                return cursorLoader;
...
//  TODO (26) Change onLoadFinished parameter to a Loader<Cursor> instead of a Loader<String[]>
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        Log.d(TAG, "Created cursor: " + String.valueOf(loader.hashCode()));
