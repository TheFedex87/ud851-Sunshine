...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        new GetWeatherDataTask().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }
    ...
    public class GetWeatherDataTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try{
                ...
                String[] jsonData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResponse);
